    ...
    <div>
        ...
        <div>
          ...
          <div className="flex items-center">
            ...
            <p className="font-bold mx-2">
              ঠিকানা: কুলাঘাট উচ্চ বিদ্যালয়, গ্রাম: কুলাঘাট, ডাকঘর: কুলাঘাট
              লালমনিরহাট সদর, লালমনিরহাট
            </p>
          </div>
          <div className="flex items-center">
            <BsTelephoneFill size={22} color="green" />
            <p className="font-bold mx-2">মোবাইল +8801744-769331</p>
          </div>
          <div className="flex items-center">
            <MdEmail size={22} color="green" />
            <p className="font-bold mx-2">
              ইমেইল: kulaghathighschool@gmail.com
            </p>
          </div>
        </div>
      </footer>
      <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
        <div className="items-center grid-flow-col">
          ...
          <p>
            <span className="font-bold">কুলাঘাট উচ্চ বিদ্যালয়</span> <br />
